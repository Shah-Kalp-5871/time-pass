                ...
                <div className="p-10 rounded-3xl border border-white/10 shadow-lg shadow-black/50 bg-zinc-900/50 backdrop-blur-sm max-w-xs w-full" key={i}>
                  ...
                  <div className="flex items-center gap-2 mt-5">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="leading-5 opacity-60 tracking-tight text-zinc-400">{role}</div>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <div className="container z-10 mx-auto">
        ...
        >
          <div className="flex justify-center">
            <div className="border border-white/20 py-1 px-4 rounded-lg text-sm text-zinc-300 tracking-wide uppercase">Testimonials</div>
          </div>
