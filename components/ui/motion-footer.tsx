...
@keyframes footer-heartbeat {
  0%, 100% { transform: scale(1); filter: drop-shadow(0 0 5px color-mix(in oklch, var(--foreground) 30%, transparent)); }
  15%, 45% { transform: scale(1.1); filter: drop-shadow(0 0 10px color-mix(in oklch, var(--foreground) 50%, transparent)); }
...
.footer-aurora {
  background: radial-gradient(
    ...
    color-mix(in oklch, var(--muted) 5%, transparent) 40%, 
    transparent 70%
  );
}
...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Swiss Precision</span> <span className="text-zinc-500">✦</span>
    <span>Aerospace Titanium</span> <span className="text-zinc-500">✦</span>
    <span>Super-LumiNova® Engine</span> <span className="text-zinc-500">✦</span>
    <span>Exclusively Numbered</span> <span className="text-zinc-500">✦</span>
    <span>Generational Legacy</span> <span className="text-zinc-500">✦</span>
  </div>
);
        ...
        <footer className="fixed bottom-0 left-0 flex h-[100dvh] w-full flex-col justify-between overflow-hidden bg-black text-white cinematic-footer-wrapper border-t border-white/5 pb-2">
          ...
          <div className="relative z-20 w-full pb-4 md:pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6 mt-auto">
            ...
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default border-white/10">
              <span className="text-zinc-400 text-[10px] md:text-xs font-bold uppercase tracking-widest">Swiss</span>
              <span className="animate-footer-heartbeat text-sm md:text-base text-zinc-200">⨂</span>
              <span className="text-zinc-400 text-[10px] md:text-xs font-bold uppercase tracking-widest">Made</span>
            </div>
